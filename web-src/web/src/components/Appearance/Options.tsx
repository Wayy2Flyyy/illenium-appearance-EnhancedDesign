...
const ToggleButton = styled.button<ToggleButtonProps>`
  ...
  &:hover {
    ...
    background: rgba(var(--w2f-accent), 0.65);
...
const GlassToggleButton = styled.button<ToggleButtonProps>`
  ...
  border: 1px solid
    ${({ active }) => (active ? 'rgba(var(--w2f-accent), 0.45)' : 'rgba(255, 255, 255, 0.08)')};
  background: ${({ active }) =>
    active ? 'rgba(var(--w2f-accent), 0.12)' : 'transparent'};
  ...
  &:hover {
    ...
    background: ${({ active }) =>
      active ? 'rgba(var(--w2f-accent), 0.2)' : 'rgba(255, 255, 255, 0.07)'};
  }
